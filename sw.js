// sw.js - Service Worker V966 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v966'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=966',
  './style.css?v=966',
  ...
  './js/storage.js?v=966',
  './js/speechcache.js?v=966',
  './js/config.js?v=966',
  './js/state.js?v=966',
  './js/audio.js?v=966',
  './js/ai.js?v=966',
  './js/ui.js?v=966',
  './js/homework.js?v=966',
  './js/game.js?v=966',
  './js/print.js?v=966',
  './js/spelling.js?v=966',
  './js/ocr.js?v=966',
  './js/main.js?v=966'
];
