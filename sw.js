// sw.js - Service Worker V1014 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v1014'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1014',
  './style.css?v=1014',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1014',
  './Practice.png?v=1014',
  './presets.webp?v=1014',
  './game.webp?v=1014',
  './parent.webp?v=1014',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1014',
  './js/speechcache.js?v=1014',
  './js/config.js?v=1014',
  './js/state.js?v=1014',
  './js/audio.js?v=1014',
  './js/ai.js?v=1014',
  './js/ui.js?v=1014',
  './js/homework.js?v=1014',
  './js/game.js?v=1014',
  './js/print.js?v=1014',
  './js/spelling.js?v=1014',
  './js/ocr.js?v=1014',
  './js/main.js?v=1014'
];
