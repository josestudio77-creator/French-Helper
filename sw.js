// sw.js - Service Worker V997 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v997'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=997',
  './style.css?v=997',
  ...
  './js/storage.js?v=997',
  './js/speechcache.js?v=997',
  './js/config.js?v=997',
  './js/state.js?v=997',
  './js/audio.js?v=997',
  './js/ai.js?v=997',
  './js/ui.js?v=997',
  './js/homework.js?v=997',
  './js/game.js?v=997',
  './js/print.js?v=997',
  './js/spelling.js?v=997',
  './js/ocr.js?v=997',
  './js/main.js?v=997'
];
