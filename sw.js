...
const CACHE_NAME = 'french-fun-v1034'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1034',
  './style.css?v=1034',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1034',
  './Practice.png?v=1034',
  './presets.webp?v=1034',
  './game.webp?v=1034',
  './parent.webp?v=1034',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1034',
  './js/speechcache.js?v=1034',
  './js/config.js?v=1034',
  './js/state.js?v=1034',
  './js/audio.js?v=1034',
  './js/ai.js?v=1034',
  './js/ui.js?v=1034',
  './js/homework.js?v=1034',
  './js/game.js?v=1034',
  './js/puzzle.js?v=1034',
  './js/print.js?v=1034',
  './js/spelling.js?v=1034',
  './js/ocr.js?v=1034',
  './js/main.js?v=1034'
];
