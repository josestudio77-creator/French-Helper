// sw.js - Service Worker V961 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v961'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=961',
  './style.css?v=961',
  ...
  './js/storage.js?v=961',
  './js/speechcache.js?v=961',
  './js/config.js?v=961',
  './js/state.js?v=961',
  './js/audio.js?v=961',
  './js/ai.js?v=961',
  './js/ui.js?v=961',
  './js/homework.js?v=961',
  './js/game.js?v=961',
  './js/print.js?v=961',
  './js/spelling.js?v=961',
  './js/ocr.js?v=961',
  './js/main.js?v=961'
];
