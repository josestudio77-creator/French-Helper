...
const CACHE_NAME = 'french-fun-v1050'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1050',
  './style.css?v=1050',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1050',
  './Practice.png?v=1050',
  './presets.webp?v=1050',
  './game.webp?v=1050',
  './parent.webp?v=1050',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1050',
  './js/speechcache.js?v=1050',
  './js/config.js?v=1050',
  './js/state.js?v=1050',
  './js/audio.js?v=1050',
  './js/ai.js?v=1050',
  './js/ui.js?v=1050',
  './js/homework.js?v=1050',
  './js/game.js?v=1050',
  './js/puzzle.js?v=1050',
  './js/print.js?v=1050',
  './js/spelling.js?v=1050',
  './js/ocr.js?v=1050',
  './js/main.js?v=1050'
];
