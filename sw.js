// sw.js - Service Worker V944 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v944'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=944',
  './style.css?v=944',
  ...
  './js/storage.js?v=944',
  './js/speechcache.js?v=944',
  './js/config.js?v=944',
  './js/state.js?v=944',
  './js/audio.js?v=944',
  './js/ai.js?v=944',
  './js/ui.js?v=944',
  './js/homework.js?v=944',
  './js/game.js?v=944',
  './js/print.js?v=944',
  './js/spelling.js?v=944',
  './js/ocr.js?v=944',
  './js/main.js?v=944'
];
