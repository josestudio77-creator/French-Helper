// sw.js - Service Worker V1006 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v1006'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1006',
  './style.css?v=1006',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1006',
  './Practice.png?v=1006',
  './presets.webp?v=1006',
  './game.webp?v=1006',
  './parent.webp?v=1006',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1006',
  './js/speechcache.js?v=1006',
  './js/config.js?v=1006',
  './js/state.js?v=1006',
  './js/audio.js?v=1006',
  './js/ai.js?v=1006',
  './js/ui.js?v=1006',
  './js/homework.js?v=1006',
  './js/game.js?v=1006',
  './js/print.js?v=1006',
  './js/spelling.js?v=1006',
  './js/ocr.js?v=1006',
  './js/main.js?v=1006'
];
