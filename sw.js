// sw.js - Service Worker V947 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v947'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=947',
  './style.css?v=947',
  ...
  './js/storage.js?v=947',
  './js/speechcache.js?v=947',
  './js/config.js?v=947',
  './js/state.js?v=947',
  './js/audio.js?v=947',
  './js/ai.js?v=947',
  './js/ui.js?v=947',
  './js/homework.js?v=947',
  './js/game.js?v=947',
  './js/print.js?v=947',
  './js/spelling.js?v=947',
  './js/ocr.js?v=947',
  './js/main.js?v=947'
];
