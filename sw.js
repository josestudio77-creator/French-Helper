// sw.js - Service Worker V985 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v985'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=985',
  './style.css?v=985',
  ...
  './js/storage.js?v=985',
  './js/speechcache.js?v=985',
  './js/config.js?v=985',
  './js/state.js?v=985',
  './js/audio.js?v=985',
  './js/ai.js?v=985',
  './js/ui.js?v=985',
  './js/homework.js?v=985',
  './js/game.js?v=985',
  './js/print.js?v=985',
  './js/spelling.js?v=985',
  './js/ocr.js?v=985',
  './js/main.js?v=985'
];
