// sw.js - Service Worker V1009 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v1009'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1009',
  './style.css?v=1009',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1009',
  './Practice.png?v=1009',
  './presets.webp?v=1009',
  './game.webp?v=1009',
  './parent.webp?v=1009',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1009',
  './js/speechcache.js?v=1009',
  './js/config.js?v=1009',
  './js/state.js?v=1009',
  './js/audio.js?v=1009',
  './js/ai.js?v=1009',
  './js/ui.js?v=1009',
  './js/homework.js?v=1009',
  './js/game.js?v=1009',
  './js/print.js?v=1009',
  './js/spelling.js?v=1009',
  './js/ocr.js?v=1009',
  './js/main.js?v=1009'
];
