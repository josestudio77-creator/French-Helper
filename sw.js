// sw.js - Service Worker V960 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v960'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=960',
  './style.css?v=960',
  ...
  './js/storage.js?v=960',
  './js/speechcache.js?v=960',
  './js/config.js?v=960',
  './js/state.js?v=960',
  './js/audio.js?v=960',
  './js/ai.js?v=960',
  './js/ui.js?v=960',
  './js/homework.js?v=960',
  './js/game.js?v=960',
  './js/print.js?v=960',
  './js/spelling.js?v=960',
  './js/ocr.js?v=960',
  './js/main.js?v=960'
];
