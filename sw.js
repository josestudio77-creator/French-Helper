// sw.js - Service Worker V993 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v993'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=993',
  './style.css?v=993',
  ...
  './js/storage.js?v=993',
  './js/speechcache.js?v=993',
  './js/config.js?v=993',
  './js/state.js?v=993',
  './js/audio.js?v=993',
  './js/ai.js?v=993',
  './js/ui.js?v=993',
  './js/homework.js?v=993',
  './js/game.js?v=993',
  './js/print.js?v=993',
  './js/spelling.js?v=993',
  './js/ocr.js?v=993',
  './js/main.js?v=993'
];
