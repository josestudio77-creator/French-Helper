// sw.js - Service Worker V1007 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v1007'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1007',
  './style.css?v=1007',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1007',
  './Practice.png?v=1007',
  './presets.webp?v=1007',
  './game.webp?v=1007',
  './parent.webp?v=1007',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1007',
  './js/speechcache.js?v=1007',
  './js/config.js?v=1007',
  './js/state.js?v=1007',
  './js/audio.js?v=1007',
  './js/ai.js?v=1007',
  './js/ui.js?v=1007',
  './js/homework.js?v=1007',
  './js/game.js?v=1007',
  './js/print.js?v=1007',
  './js/spelling.js?v=1007',
  './js/ocr.js?v=1007',
  './js/main.js?v=1007'
];
