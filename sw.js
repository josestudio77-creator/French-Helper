// sw.js - Service Worker V1008 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v1008'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1008',
  './style.css?v=1008',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1008',
  './Practice.png?v=1008',
  './presets.webp?v=1008',
  './game.webp?v=1008',
  './parent.webp?v=1008',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1008',
  './js/speechcache.js?v=1008',
  './js/config.js?v=1008',
  './js/state.js?v=1008',
  './js/audio.js?v=1008',
  './js/ai.js?v=1008',
  './js/ui.js?v=1008',
  './js/homework.js?v=1008',
  './js/game.js?v=1008',
  './js/print.js?v=1008',
  './js/spelling.js?v=1008',
  './js/ocr.js?v=1008',
  './js/main.js?v=1008'
];
