// sw.js - Service Worker V941 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v941'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=941',
  './style.css?v=941',
  ...
  './js/storage.js?v=941',
  './js/speechcache.js?v=941',
  './js/config.js?v=941',
  './js/state.js?v=941',
  './js/audio.js?v=941',
  './js/ai.js?v=941',
  './js/ui.js?v=941',
  './js/homework.js?v=941',
  './js/game.js?v=941',
  './js/print.js?v=941',
  './js/spelling.js?v=941',
  './js/ocr.js?v=941',
  './js/main.js?v=941'
];
