// sw.js - Service Worker V1017 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v1017'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1017',
  './style.css?v=1017',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1017',
  './Practice.png?v=1017',
  './presets.webp?v=1017',
  './game.webp?v=1017',
  './parent.webp?v=1017',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1017',
  './js/speechcache.js?v=1017',
  './js/config.js?v=1017',
  './js/state.js?v=1017',
  './js/audio.js?v=1017',
  './js/ai.js?v=1017',
  './js/ui.js?v=1017',
  './js/homework.js?v=1017',
  './js/game.js?v=1017',
  './js/print.js?v=1017',
  './js/spelling.js?v=1017',
  './js/ocr.js?v=1017',
  './js/main.js?v=1017'
];
