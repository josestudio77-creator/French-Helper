// sw.js - Service Worker V984 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v984'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=984',
  './style.css?v=984',
  ...
  './js/storage.js?v=984',
  './js/speechcache.js?v=984',
  './js/config.js?v=984',
  './js/state.js?v=984',
  './js/audio.js?v=984',
  './js/ai.js?v=984',
  './js/ui.js?v=984',
  './js/homework.js?v=984',
  './js/game.js?v=984',
  './js/print.js?v=984',
  './js/spelling.js?v=984',
  './js/ocr.js?v=984',
  './js/main.js?v=984'
];
