// sw.js - Service Worker V946 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v946'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=946',
  './style.css?v=946',
  ...
  './js/storage.js?v=946',
  './js/speechcache.js?v=946',
  './js/config.js?v=946',
  './js/state.js?v=946',
  './js/audio.js?v=946',
  './js/ai.js?v=946',
  './js/ui.js?v=946',
  './js/homework.js?v=946',
  './js/game.js?v=946',
  './js/print.js?v=946',
  './js/spelling.js?v=946',
  './js/ocr.js?v=946',
  './js/main.js?v=946'
];
