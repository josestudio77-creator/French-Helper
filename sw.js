// sw.js - Service Worker V939 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v939'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=939',
  './style.css?v=939',
  ...
  './js/storage.js?v=939',
  './js/speechcache.js?v=939',
  './js/config.js?v=939',
  './js/state.js?v=939',
  './js/audio.js?v=939',
  './js/ai.js?v=939',
  './js/ui.js?v=939',
  './js/homework.js?v=939',
  './js/game.js?v=939',
  './js/print.js?v=939',
  './js/spelling.js?v=939',
  './js/ocr.js?v=939',
  './js/main.js?v=939'
];
