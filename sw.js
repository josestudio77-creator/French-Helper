...
const CACHE_NAME = 'french-fun-v1051'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1051',
  './style.css?v=1051',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1051',
  './Practice.png?v=1051',
  './presets.webp?v=1051',
  './game.webp?v=1051',
  './parent.webp?v=1051',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1051',
  './js/speechcache.js?v=1051',
  './js/config.js?v=1051',
  './js/state.js?v=1051',
  './js/audio.js?v=1051',
  './js/ai.js?v=1051',
  './js/ui.js?v=1051',
  './js/homework.js?v=1051',
  './js/game.js?v=1051',
  './js/puzzle.js?v=1051',
  './js/print.js?v=1051',
  './js/spelling.js?v=1051',
  './js/ocr.js?v=1051',
  './js/main.js?v=1051'
];
