// sw.js - Service Worker V996 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v996'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=996',
  './style.css?v=996',
  ...
  './js/storage.js?v=996',
  './js/speechcache.js?v=996',
  './js/config.js?v=996',
  './js/state.js?v=996',
  './js/audio.js?v=996',
  './js/ai.js?v=996',
  './js/ui.js?v=996',
  './js/homework.js?v=996',
  './js/game.js?v=996',
  './js/print.js?v=996',
  './js/spelling.js?v=996',
  './js/ocr.js?v=996',
  './js/main.js?v=996'
];
