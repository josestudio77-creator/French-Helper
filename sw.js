...
const CACHE_NAME = 'french-fun-v1032'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1032',
  './style.css?v=1032',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1032',
  './Practice.png?v=1032',
  './presets.webp?v=1032',
  './game.webp?v=1032',
  './parent.webp?v=1032',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1032',
  './js/speechcache.js?v=1032',
  './js/config.js?v=1032',
  './js/state.js?v=1032',
  './js/audio.js?v=1032',
  './js/ai.js?v=1032',
  './js/ui.js?v=1032',
  './js/homework.js?v=1032',
  './js/game.js?v=1032',
  './js/puzzle.js?v=1032',
  './js/print.js?v=1032',
  './js/spelling.js?v=1032',
  './js/ocr.js?v=1032',
  './js/main.js?v=1032'
];
