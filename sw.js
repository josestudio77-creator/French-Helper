// sw.js - Service Worker V938 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v938'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=938',
  './style.css?v=938',
  ...
  './js/storage.js?v=938',
  './js/speechcache.js?v=938',
  './js/config.js?v=938',
  './js/state.js?v=938',
  './js/audio.js?v=938',
  './js/ai.js?v=938',
  './js/ui.js?v=938',
  './js/homework.js?v=938',
  './js/game.js?v=938',
  './js/print.js?v=938',
  './js/spelling.js?v=938',
  './js/ocr.js?v=938',
  './js/main.js?v=938'
];
