// sw.js - Service Worker V967 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v967'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=967',
  './style.css?v=967',
  ...
  './js/storage.js?v=967',
  './js/speechcache.js?v=967',
  './js/config.js?v=967',
  './js/state.js?v=967',
  './js/audio.js?v=967',
  './js/ai.js?v=967',
  './js/ui.js?v=967',
  './js/homework.js?v=967',
  './js/game.js?v=967',
  './js/print.js?v=967',
  './js/spelling.js?v=967',
  './js/ocr.js?v=967',
  './js/main.js?v=967'
];
