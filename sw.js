// sw.js - Service Worker V951 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v951'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=951',
  './style.css?v=951',
  ...
  './js/storage.js?v=951',
  './js/speechcache.js?v=951',
  './js/config.js?v=951',
  './js/state.js?v=951',
  './js/audio.js?v=951',
  './js/ai.js?v=951',
  './js/ui.js?v=951',
  './js/homework.js?v=951',
  './js/game.js?v=951',
  './js/print.js?v=951',
  './js/spelling.js?v=951',
  './js/ocr.js?v=951',
  './js/main.js?v=951'
];
