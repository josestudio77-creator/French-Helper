// sw.js - Service Worker V958 (Modular JS architecture)
const CACHE_NAME = 'french-fun-v958'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=958',
  './style.css?v=958',
  ...
  './js/storage.js?v=958',
  './js/speechcache.js?v=958',
  './js/config.js?v=958',
  './js/state.js?v=958',
  './js/audio.js?v=958',
  './js/ai.js?v=958',
  './js/ui.js?v=958',
  './js/homework.js?v=958',
  './js/game.js?v=958',
  './js/print.js?v=958',
  './js/spelling.js?v=958',
  './js/ocr.js?v=958',
  './js/main.js?v=958'
];
