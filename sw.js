...
const CACHE_NAME = 'french-fun-v1036'; // Bumped: force UI updates on mobile
const urlsToCache = [
  './',
  './index.html?v=1036',
  './style.css?v=1036',
  './manifest.json',
  './icon.png',
  './backpack.webp?v=1036',
  './Practice.png?v=1036',
  './presets.webp?v=1036',
  './game.webp?v=1036',
  './parent.webp?v=1036',
  './KGPrimaryPenmanshipAlt.woff2',
  './js/storage.js?v=1036',
  './js/speechcache.js?v=1036',
  './js/config.js?v=1036',
  './js/state.js?v=1036',
  './js/audio.js?v=1036',
  './js/ai.js?v=1036',
  './js/ui.js?v=1036',
  './js/homework.js?v=1036',
  './js/game.js?v=1036',
  './js/puzzle.js?v=1036',
  './js/print.js?v=1036',
  './js/spelling.js?v=1036',
  './js/ocr.js?v=1036',
  './js/main.js?v=1036'
];
